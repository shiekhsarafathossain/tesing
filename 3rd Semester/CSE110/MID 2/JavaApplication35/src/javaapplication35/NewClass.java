				...
				case(1):
				{
					...
					switch (j)
					{
						...
						case(14):{
							...
							else System.out.println("Unsuccessful Attempt");
							f=false;
							break;
						}
						case(15):{
							...
							if(f) System.out.println("Student added successfully");
							else System.out.println("Unsuccessful Attempt");
							f=false;
							break;
						}
				...
				case(2):
				{
					...
					switch(p)
					{
						case(21):
						{
							...
							if(f) System.out.println("Student removed successfully.");
							else System.out.println("Unsuccessful attempt. Student not found.");
							f=false;
							break;
						}
						case(22):
						{
							...
							else System.out.println("Unsuccessful attempt. Course not found.");
							f=false;
							break;
						}
						case(23):
				...
				case(3):
				{
					...
					switch(u)
					{
						case(31):
						{
							...
							if(f) System.out.println("Updated Successfully");
							else System.out.println("Unsuccessful attempt. Student not found.");
							f=false;
							break;
						}
				...
				case(4):
				{
					...
					switch(cho)
					{
						...
						case(44):
						{
							...
							if(!f) System.out.println("Unsuccessful attempt.");
							f=false;
							break;
						}
						case(45):
				...
				case(5):
				{
					...
					switch (co)
					{
						case(51):
						{
							...
							if(!f) System.out.println("Unsuccessful attempt. Student not found.");
							f=false;
							break;
						}
						case(52):
						{
							...
							if(!f) System.out.println("Unsuccessful attempt. Course not found.");
							f=false;
							break;
						}
						case(53):
						{
							...
							if(!f) System.out.println("Unsuccessful attempt. Faculty not found.");
							f=false;
							break;
						}
						case(54):

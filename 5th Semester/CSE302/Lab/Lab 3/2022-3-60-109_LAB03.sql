...
WHERE l.amount >= 1000 AND l.loan_number = b.loan_number 
AND b.customer_name = c.customer_name AND c.customer_city = 'Harrison'; -- 4
...
AND a.balance = (SELECT MAX(balance) FROM account); -- 15
